import type { NotificationEntity } from "@/domain/model/notification.entity";
import type { ParametersDTO } from "./dto";

/**
 * WorkerClient는 마이크로서비스와의 통신을 담당하는 추상 클래스입니다.
 */
export default abstract class WorkerClient {
     ...
     */
    abstract readByOptions(query: ParametersDTO): Promise<NotificationEntity[]>;
     ...
     */
    abstract updatePartial(query: ParametersDTO & { event_id: string }): Promise<NotificationEntity>;
}
